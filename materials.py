...
class Material:
    ...
    def __init__(self, name, eps, Eg, Nc, Nv, chi, mc, mv,gamma,delta,kappa,magq):
        """
        Create material.
...
Ge = Material("Ge",
    ...
    gamma=[13.380, 4.24, 5.69], delta = 0.2964,kappa =3.41, magq=0.06)


Al2O3 = Material("Al2O3",
    eps=9.0*eps0, Eg=6.2, Nc=1.5e18, Nv = 1.5e18,
    chi=1.95, mc=0.2, mv=[0.78623495,0.78623495,0.1625266,0.1625266],
    gamma = [3.76 ,0.82,1.420], delta=0.3,kappa =3.41, magq=0.06)
...
SiGe80 = Material("SiGe80",
    ...
    chi=4.01, mc=0.23972605,mv=[0.36933235,0.36933235,0.05108412,0.05108412],
    gamma=[11.5610, 3.4598, 4.8412], delta =0.246,kappa =3.41, magq=0.06)
