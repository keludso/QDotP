...
Extrude {0, 0, Plunger_barrier_ht} {Surface{88,92,96,100,104,108,112,116,120};}

Extrude {0, 0, Thermal_SiO2} {Surface{125,129,133,137,141,145,149,153,157};}
...
Physical Volume("Si_substrate") = {46:54};
...
Physical Volume("Si_barrier1") = {28,37};            // Layer 2 volumes

Physical Volume("Si_barrier2") = {32,41};            // Layer 2 volumes

Physical Volume("Si_barrier3") = {36,45};            // Layer 2 volumes

Physical Volume("Si_plunger1") = {39};            // Layer 2 volumes

Physical Volume("Si_plunger2") = {43};            // Layer 2 volumes

Physical Volume("SiO2_cap") = {38,29,31,40,33,42,44,35,30,34};            // Layer 2 volumes
...
//===============================================
// Bottom surfaces
Physical Surface("bottom_surface") = {199,203,207,211,215,219,223,227,231};

// Contact surfaces
Physical Surface("Barrier1") = {162};
Physical Surface("Barrier2") = {178};
Physical Surface("Barrier3") = {194};

Physical Surface("Plunger1") = {170};
Physical Surface("Plunger2") = {186};
