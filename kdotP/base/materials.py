...
GeSn15 = Material("GeSn15",
    ...
    Nc = 2.9461e24, 
    Nv = 5.9235e24,
    mv=[0.34624157, 0.34624157, 0.04230065, 0.04230065],
    gamma=[21.43951875, 8.42955625, 9.88551875],
    delta=0.37985,
    kappa=1.1225,
    magq=0.096,
    deformation_pot=[1.291, -2.836, -5.103],
    Kane_Ep = 21.0
)

GeSn08 = Material("GeSn08",
    eps=16.64*eps0,
    Eg=0.613996,
    chi=3.7444,
    Nc = 2.9461e24, 
    ...
    mc=0.06988,
    mv=[0.34624157, 0.34624157, 0.04230065, 0.04230065],
    gamma=[14.830936, 5.121904, 6.552992],
    delta=0.34128,
    kappa=2.19,
    magq=0.0792,
    deformation_pot=[1.2672, -2.8472, -5.1856],
    Kane_Ep = 21.0
)
...
Si = Material(
    ...
    eps=11.7 * eps0,
    Eg=1.12,
    Nc=2.80e25,                 # m^-3 at 300 K
    Nv=1.04e25,                 # m^-3 at 300 K
    chi=4.05,
    mc= [0.26, 0.26,0.26],
    mv=[0.49, 0.49, 0.16, 0.16],
    gamma=[4.285, 0.339, 1.446],
    delta=0.044,
    kappa=-0.42,
    magq=0.02,
    deformation_pot=[-8.6, 2.1, -2.3],
    Kane_Ep=21.6
)
...
SiO2 = Material(
    ...
    eps=3.9 * eps0,
    Eg=9.0,
    Nc=1.0e10,                 # Small placeholder value for an insulator
    Nv=1.0e10,                 # Small placeholder value for an insulator
    chi=0.95,
    mc= [0.50, 0.50,0.50],
    mv=[0.58, 0.58, 0.58, 0.58],
    gamma=[0.0, 0.0, 0.0],
    delta=0.0,
    kappa=0.0,
    magq=0.0,
    deformation_pot=[0.0, 0.0, 0.0],
    Kane_Ep=0.0
)
